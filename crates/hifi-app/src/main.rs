...
fn bind_keys(cx: &mut App) {
    cx.bind_keys([
        ...
        KeyBinding::new("cmd-a", text_input::SelectAll, Some("TextField")),
        KeyBinding::new("cmd-x", text_input::Cut, Some("TextField")),
        KeyBinding::new("cmd-c", text_input::Copy, Some("TextField")),
        KeyBinding::new("cmd-v", text_input::Paste, Some("TextField")),
